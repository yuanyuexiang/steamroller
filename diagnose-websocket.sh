...
# 检查服务器基本连接
echo "1. 检查服务器HTTP连接..."
curl -I https://steamroller.kcbaotech.com/server/ping 2>/dev/null || echo "HTTP连接失败"

echo
echo "2. 检查GraphQL端点..."
curl -I https://steamroller.kcbaotech.com/graphql 2>/dev/null || echo "GraphQL端点无响应"

echo
echo "3. 尝试WebSocket连接测试..."
echo "使用wscat测试（如果安装了）:"
echo "wscat -c wss://steamroller.kcbaotech.com/graphql"
...
echo
echo "5. 网络诊断..."
ping -c 3 steamroller.kcbaotech.com
